from sentence_transformers import SentenceTransformer #model do tworzenia embedgingów tekstu
from qdrant_client import QdrantClient, models #kilent do komunikacji z bazą danych qdrant

from io import BytesIO #ciągi bitów jako plik pamięci
from pypdf import PdfReader 
import uuid #unikalne identyfikatory dla stron
import re #usuwa znaki sterujące z teksty
from typing import Iterable

CTRL = re.compile(r"[\x00-\x1f]+") #wzorzec do usuwania znaków sterujących

#model jezykowy do tworzenia embedingów
...
def _to_string(x: Iterable | bytes | str) -> str:
    """Normalizuje wejściowy obiekt do czystego łańcuchu znaków"""
